...
import { AbschlussTabelleComponent } from './components/abschluss-tabelle/abschluss-tabelle.component';
...
export const routes: Routes = [
  ...
  { path: 'turnier/:id/abschluss', component: AbschlussTabelleComponent }
];